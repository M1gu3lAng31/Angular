...
public ReturnListaProductos(){
    return this.Productos;
}

public buscarProductos(idProducto){
...
public BuscarProductoPorTermino(termino:string){
    termino=termino.toLowerCase();

    return this.Productos.filter((producto)=>producto.productName.toLowerCase().indexOf(termino)>-1)
